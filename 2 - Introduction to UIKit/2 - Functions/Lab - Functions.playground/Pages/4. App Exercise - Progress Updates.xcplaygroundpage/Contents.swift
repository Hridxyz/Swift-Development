...
func progressUpdate(steps: Int, goal: Int) {
    let percentageOfGoal = Double(steps) / Double(goal)
    if percentageOfGoal < 0.1 {
        print("You're off to a good start.")
    } else if percentageOfGoal < 0.5 {
        print("You're almost halfway there!")
    } else if percentageOfGoal < 0.9 {
...
pacing(currentDistance: 0.3, totalDistance: 5.0, currentTime: 20.0, goalTime: 100.0)
